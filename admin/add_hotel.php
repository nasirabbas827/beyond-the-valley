...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // if everything is ok, try to upload file
        ...
        if (move_uploaded_file($_FILES["hotelPicture"]["tmp_name"], $targetFile)) {
            ...
            $insertQuery = "INSERT INTO hotel (hotel_name, place_id, contact_number, number_of_rooms, room_types, amenities, description, hotel_picture, price) 
                            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";

            $stmt = $conn->prepare($insertQuery);
            $stmt->bind_param('sisisssss', $hotelName, $placeID, $contactNumber, $numberOfRooms, $roomTypes, $amenities, $description, $targetFile, $price);
...
<div class="container mt-4 mb-5">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="numberOfRooms" required>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="roomTypes">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="form-control" name="hotelPicture" accept="image/*" required>
                </div>
    ...
    <a href="view_hotels.php" class="btn btn-secondary">View Hotels</a>
